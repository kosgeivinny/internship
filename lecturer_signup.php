    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right main-nav">
                <li class="active"><a href="lecturer_signup.php" class="btn btn-blue"><span class="glyphicon glyphicon-user"></span>Sign Up</a></li>
...
<div class="container" style="padding-left: 230px;">
    <div class="col-lg-10 well" style="background-color: greenyellow;">
        <div style="padding-left: 230px">
            <ul class="nav navbar-nav main-nav">
                <li><a href="student_signup.php"> <b>Student</b> </a></li>
                <li class="active"><a href="lecturer_signup.php" type="submit"><b>Lecturer</b> </a></li>
                <li><a href="org_signup.php"> <b>Org-Admin</b> </a></li>
            </ul>

        </div>
        <div class="row" style="padding-left: 80px">
            <form method="POST" action="lecturer_connect.php" enctype="multipart/form-data">
                <div class="col-md-12">
                    <br>
