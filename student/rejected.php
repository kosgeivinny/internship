...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            <div class="row">
                <div class="col-lg-12">
                    <h2 align="center" style="-webkit-text-fill-color: darkgreen"><b>REJECTED APPLICATIONS</b></h2>
                </div>
            </div>
            <!-- /. ROW  -->
            <hr />
            ...
            $query="SELECT * FROM internships inner join applications on applications.Title=internships.Title and applications.Organization=internships.Organization WHERE Reg_Number='$reg' AND Status='Rejected'";
                ...
                <div class="container bg-success" style="width: 650px;">
                    ...
                    while($row=mysqli_fetch_assoc($result)){
                        ...
                        <div class="well" style="padding-left: 100px; padding-right: 80px">
                            ...
                            <a role="button" href="apply.php?organization=<?php echo $row['Organization']?>&title=<?php echo $row['Title'] ?>" class="btn btn-block btn-success">Apply</a>
