...
<div id="wrapper">
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            <div class="row">
                <div class="col-lg-12">
                    <h2 align="center" style="-webkit-text-fill-color: darkgreen"><b>PENDING APPLICATIONS</b></h2>
                </div>
            </div>
            <!-- /. ROW  -->
            <hr />
            ...
            $query="SELECT * FROM internships inner join applications on applications.Title=internships.Title and applications.Organization=internships.Organization WHERE Reg_Number='$reg' AND Status='Pending'";
