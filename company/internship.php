        ...
        <aside>
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a class="active"  href="internship.php">
                            ...
                            <div class="container">
                                <div class="col-lg-8 well" style="background-color: greenyellow;">
                                    ...
                                    <div class="row" style="padding-left: 80px">
                                        <form method="POST" action="internship_connect.php" enctype="multipart/form-data">
                                            <legend>Internship Registration</legend>
                                            <div class="col-md-12">
                                                <br>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-5 form-group">
                                                        <label> Title: </label>
                                                        <input type="text" name="title" placeholder="Enter Internship title.." class="form-control">
                                                    </div>
                                                    <div class="col-sm-5 form-group">
                                                        <label> Slots: </label>
                                                        <input type="int" name="slots" placeholder="Number of Slots Available.." class="form-control">
                                                    </div>

                                                </div>
                                                <input type="text" name="organization" value="<?php echo $_SESSION['org']; ?>" hidden>
                                                <div class="row">
                                                    <div class="col-sm-5 form-group">
                                                        ...
                                                        <select class="form-control" name="dept">
                                                            <?php
                                                            $org = $_SESSION['org'];
                                                            $select = "SELECT Department FROM department WHERE Organization = '$org'";
                                                    ...
                                                    <div class="col-sm-5 form-group">
                                                        <label> Stipend: </label>
                                                        <input type="int"class="form-control" name="stipend" placeholder="Ksh.">
                                                    </div>
                                                </div>
