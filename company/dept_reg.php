            ...
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="mt">
                        ...
                        <ul class="sub">
                            <li class="active"><a  href="dept_reg.php">Register</a></li>
                            ...
                            <div id="container_demo">
                                <div id="wrapper">
                                    <div id="login" class="animate form">
                                        <form method="POST" action="dept_connect.php" enctype="multipart/form-data">
                                            <h1>Department Registration</h1>
                                            <p>
                                                <label>Department Name:</label>
                                                <input name="dname" required="required" type="text" placeholder="Department" />
                                            </p>
                                            <p>
                                                <label>Supervisor's First Name:</label>
                                                <input name="firstname" required="required" type="text" placeholder="First Name" />
                                            </p>
                                            <p>
                                                <label> Supervisor's Last Name:</label>
                                                <input name="lastname" required="required" type="text" placeholder="Last Name"/>
                                            </p>
                                            <input name="org" required="required" type="text" value="<?php echo $_SESSION['org'];?>" hidden/>
