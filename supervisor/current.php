            ...
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu" align="center" id="nav-accordion">
                    ...
                    <button class="mt btn btn-lg btn-warning active">
                        <a class="active" href="current.php" >
                            <i class="fa fa-th"></i>
                    ...
                    <div class="col-lg-9 main-chart">
                        ...
                        <div class="row mt">
                            ...
                            <div class="col-lg-12 well" style="background-color: lightpink;">
                                ...
                                $org = $_SESSION['org'];
                                $dept = $_SESSION['dept'];
                                $pen = "SELECT * FROM applications INNER JOIN internships ON applications.Organization = internships.Organization AND applications.Title = internships.Title WHERE Department = '$dept' AND Status='Confirmed' OR Status='Connected' AND internships.Organization='$org'";
                                $pend = mysqli_query($conn, $pen);

                                echo"<div class='row' style='padding-left: 20px'>
                                <form>
                                <legend> <b><u>Current Students</u></b></legend>
                                <table class='table table-hover'>
                                    <tr class='btn-success'><th>Reg_Number</th><th> Name </th><th>Email</th><th>Institution</th><th>Title</th></tr>";

                                while ($row=mysqli_fetch_array($pend)){
                                    echo "<tr><td>".$row['Reg_Number']."</td><td>".$row['Name']."</td><td>".$row['Email']."</td><td>".$row['Institution']."</td><td>".$row['Title']."</td></tr>";
                                }
                                ?>
                                </table>
                                </form>
