            ...
            <div id="sidebar"  class="nav-collapse ">
                ...
                <ul class="sidebar-menu" align="center" id="nav-accordion">
                    ...
                    <button class="mt btn btn-lg btn-warning active">
                        <a class="active" href="viewapp.php" >
                            <i class="fa fa-th"></i>
                ...
                <div class="row">
                    <div class="col-lg-9 main-chart">
                        ...
                        <div class="row mt">
                            ...
                            <div class="col-lg-12 well" style="background-color: lightpink;">
                            <?php

                            $pen = "SELECT * FROM applications INNER JOIN internships ON applications.Organization = internships.Organization AND applications.Title = internships.Title WHERE Department = '$dept' AND Status='Pending'";
                            $pend = mysqli_query($conn, $pen);

                            echo"<div class='row' style='padding-left: 80px'>
                                <form>
                                <legend> <b><u>Current Applications</u></b></legend>
                                <table class='table table-hover'>
                                    <tr class='btn-success'><th> Name </th><th>Email</th><th>Institution</th><th>Title</th><th></th></tr>";

                                    while ($row=mysqli_fetch_array($pend)){
                                    echo "<tr><td>".$row['Name']."</td><td>".$row['Email']."</td><td>".$row['Institution']."</td><td>".$row['Title']."</td><td>
                                      <a class=' btn btn-primary'  href='confirm.php? adm=".$row['Reg_Number']."&title=".$row['Title']."&org=".$row['Organization']." &dept=".$row['Department']."'><i class='fa fa-check'></i>Accept</a>
                                      <a class='btn btn-danger' href='reject.php? adm=".$row['Reg_Number']."&title=".$row['Title']."&org=".$row['Organization']." &dept=".$row['Department']."'><i class='fa fa-trash-o'></i>Reject</a></td></tr>";
                                    }
                                    ?>
                                </table>
                            </form>
