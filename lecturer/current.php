    ...
    <div id='content'>
        <div class='panel panel-default'>
            ...
            <div class='page-header noprint'>
                <h4 class="text-center"><b>MY STUDENTS</b></h4>
            </div>
            ...
            <div class='row text-center noprint'>
                ...
                <div class="col-lg-10" style="padding-left: 150px">
                    ...
                    $pen = "SELECT * FROM applications INNER JOIN student ON applications.Reg_Number = student.Reg_Number INNER JOIN internship_assessor ON applications.Reg_Number=internship_assessor.Reg_Number WHERE Department = '$dept' AND Status='Connected' AND student.Institution='$inst' AND Lecturer='$lect'";
                    $pend = mysqli_query($conn, $pen);

                    echo"<div class='row' style='background-color: moccasin;'>
                                <form>
                                <table class='table table-hover'>
                                    <tr class='danger'><th>Reg_Number</th><th> Name </th><th>Email</th><th>Place of Attachment</th></tr>";

                    while ($row=mysqli_fetch_array($pend)){
                        echo "<tr><td>".$row['Reg_Number']."</td><td>".$row['Name']."</td><td>".$row['Email']."</td><td>".$row['Organization']."</td></tr>";
                    }
                    ?>
                    </table>
                    </form>
