    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right main-nav">
                <li class="active"><a href="org_signup.php" class="btn btn-blue"><span class="glyphicon glyphicon-user"></span>Sign Up</a></li>
...
<div class="container" style="padding-left: 230px;">
        <div class="col-lg-10 well" style="background-color: yellowgreen;">
            <div style="padding-left: 230px">
                <ul class="nav navbar-nav main-nav">
                    <li><a href="student_signup.php"> <b>Student</b> </a></li>
                    <li><a href="lecturer_signup.php" type="submit"><b>Lecturer</b> </a></li>
                    <li  class="active"><a href="org_signup.php"> <b>Org-Admin</b> </a></li>
                </ul>

            </div>
            <div class="row" style="padding-left: 80px">

                <form method="POST" action="org_connect.php" enctype="multipart/form-data">
                    <div class="col-md-12">
                        <br>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-5 form-group">
                                ...
                                <input type="text" name="org_name" placeholder=" Organization's Name.." class="form-control">
                            </div>

                            <div class="col-sm-5 form-group">
                                <label> Id Number: </label>
                                <input type="text" name="idnumber" placeholder="National Id Number.." class="form-control">
                            </div>
                        </div>
